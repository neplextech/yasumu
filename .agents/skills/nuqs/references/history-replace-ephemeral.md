...
Use `history: 'replace'` (default) for state that changes frequently
or represents intermediate values users wouldn't want to navigate
through (typing, sliders, filters).
