...
Don't copy URL state into local `useState`. This creates two sources
of truth that can drift out of sync. Use the URL state directly or
...
Reference:
[React Derived State](https://react.dev/learn/you-might-not-need-an-effect#updating-state-based-on-props-or-state)
