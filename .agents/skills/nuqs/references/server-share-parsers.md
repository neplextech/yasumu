...
Define parsers once and reuse them in both `createSearchParamsCache`
(server) and `useQueryState` (client). This ensures consistent parsing
behavior and prevents bugs from mismatched configurations.
