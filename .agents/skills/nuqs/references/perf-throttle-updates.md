...
Browsers rate-limit History API calls. Rapid updates (typing, sliders,
dragging) can exceed this limit, causing dropped updates. Use
`throttleMs` to batch updates.
...
**Note:** Minimum throttle is 50ms. UI state updates instantly
