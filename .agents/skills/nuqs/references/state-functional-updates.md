...
When the new state depends on the previous state (incrementing,
toggling, appending), use functional updates. Direct state references
in closures can be stale.
