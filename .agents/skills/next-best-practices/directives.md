...
Marks a function as a Server Action. Can be passed to Client
Components.
...
Marks a function or component for caching. Part of Next.js Cache
Components.
...
For detailed usage including cache profiles, `cacheLife()`,
`cacheTag()`, and `updateTag()`, see the `next-cache-components`
skill.
