...
Detect and prevent invalid patterns when crossing Server/Client
...
Client components **cannot** be async functions. Only Server
...
Functions marked with `'use server'` CAN be passed to client
components.
