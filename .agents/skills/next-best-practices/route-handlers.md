...
If you need both a page and an API at the same path, use different
paths:
...
**Prefer Server Actions** for mutations triggered from your UI. **Use
Route Handlers** for external integrations and public APIs.
