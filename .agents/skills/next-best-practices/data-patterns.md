...
Server Actions can be called from Client Components for reads, but
...
**Note**: Server Actions always use POST, so no HTTP caching. Prefer
Route Handlers for cacheable reads.
