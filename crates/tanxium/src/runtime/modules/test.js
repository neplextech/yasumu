...
var z = class extends b {
  ...
  equals(t) {
    let s = Array.isArray(t) && this.value.every((r) => t.some((n) => h(r, n, { customTesters: F() })));
...
var G = class extends b {
  ...
  equals(t) {
    let s = Object.keys(this.value),
      r = !0;
    for (let n of s) (!Object.hasOwn(t, n) || !h(this.value[n], t[n])) && (r = !1);
...
function Yt(e, t, s, r, n, o) {
  ...
  for (; !(!m && !c);) {
    let g = m;
    (c === 1
      ? (a.unshift({ type: r ? 'removed' : 'added', value: t[d] }), (d -= 1))
      : c === 3
        ? (a.unshift({ type: r ? 'added' : 'removed', value: e[l] }), (l -= 1))
        : (a.unshift({ type: 'common', value: e[l] }), (l -= 1), (d -= 1)),
      (m = n[g]),
      (c = n[g + o]));
  }
  return a;
...
function A(e, t) {
  ...
  return [...s.map((p) => ({ type: 'common', value: p })), ...Yt(e, t, $, r, d, m)];
}
function Xe(e) {
  return e
    .replaceAll('\\', '\\\\')
...
function P(e, t, s = [], r = [], n = []) {
  ...
  if (e.size !== void 0) {
    ...
    if (ut('Set', e)) {
      ...
      for (let c of e)
        if (!t.has(c)) {
          let g = !1;
          for (let $ of t) h(c, $, { customTesters: i }) === !0 && (g = !0);
          if (g === !1) {
            m = !1;
            break;
          }
      ...
      let m = !0;
      for (let c of e)
        if (!t.has(c[0]) || !h(c[1], t.get(c[0]), { customTesters: i })) {
          let g = !1;
          for (let $ of t) {
            let y = h(c[0], $[0], { customTesters: i }),
              p = !1;
            (y === !0 && (p = h(c[1], $[1], { customTesters: i })), p === !0 && (g = !0));
          }
          if (g === !1) {
            m = !1;
            break;
  ...
  for (let m of e) {
    let c = a.next();
    if (c.done || !h(m, c.value, { customTesters: i })) return !1;
  }
  if (!a.next().done) return !1;
  let l = lt(e),
    d = lt(t);
  return h(l, d) ? (r.pop(), n.pop(), !0) : !1;
}
function ge(e, t, s = []) {
  let r = s.filter((o) => o !== ge),
    n =
      ...
      (u, i) => {
        ...
        o.set(i, !0);
        let a = Qt(i).every((l) => {
          if (ft(i[l]) && o.has(i[l])) return h(u[l], i[l], { customTesters: r });
          let d = u != null && mt(u, l) && h(u[l], i[l], { customTesters: [...r, n(o)] });
          return (o.delete(i[l]), d);
        });
        return (o.delete(i), a);
      };
  return n()(e, t);
...
function qt(e, t, s) {
  ...
  let u;
  s ? (u = o !== void 0 && n.length === 0 && h(o, s, e)) : (u = o !== void 0 && n.length === 0);
  let i = '';
...
function It(e, t) {
  ...
  let n = h(s, t, { strictCheck: !1, customTesters: [...e.customTesters, P, ge] }),
    o = () => {
      if (e.isNot) {
        let u = ee(s, t);
        throw new f(e.customMessage ? `${e.customMessage}: ${u}` : u);
...
function Te(e, t) {
  let r = C(e.value).filter((o) => o.returns),
    n = r.length > 0 && h(r.at(-1)?.returned, t);
  if (e.isNot) {
    if (n) {
...
function Pt(e, t) {
  ...
  if (
    ...
    let n = !1;
    try {
      (de(e.value, s, r, e.customMessage), (n = !0));
  ...
  return de(e.value, s, r, e.customMessage);
}
var ts = [];
function Rt(e) {
  ts.unshift(e);
        ...
        get(o, u) {
          ...
          if (u === 'rejects') {
            ...
            return (
              (e = e.then(
                (d) => {
                  throw new f(`Promise did not reject: resolved to ${d}`);
                },
                (d) => d,
              )),
              (r = !0),
          ...
          return (...d) => {
            function m(c, g) {
              let $ = { value: c, equal: h, isNot: !1, customMessage: t, customTesters: F() };
              if ((s && ($.isNot = !0), u in i)) {
                let y = l($, ...g);
                if ($.isNot) {
