  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="absolute inset-0 z-0 bg-grid-pattern bg-grid pointer-events-none opacity-40"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/download"
              className="inline-flex items-center justify-center px-8 py-3.5 text-base font-medium rounded-lg text-black bg-white hover:bg-gray-200 transition-all shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:shadow-[0_0_25px_rgba(255,255,255,0.25)]"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-3.5 border border-white/20 text-base font-medium rounded-lg text-gray-300 bg-white/5 hover:bg-white/10 hover:text-white transition-all backdrop-blur-sm"
            >
              <span className="material-symbols-outlined mr-2 text-[20px]">
                code
              </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard
              ...
              description="Built with Rust and Tauri for native performance. Launches instantly and handles large responses with ease."
            />
            <FeatureCard
              icon="grid_view"
              color="purple"
            ...
            <FeatureCard
              ...
              color="green"
              title="Offline First"
              description="Your data stays on your machine. No cloud sync required unless you want it. Complete privacy."
            />
            <FeatureCard
              icon="code"
              color="orange"
              title="Code Generation"
              description="Instantly generate client code for Fetch, Axios, cURL, Python, and more from your requests."
            />
            <FeatureCard
              icon="folder_open"
              color="pink"
              title="Organized Collections"
              description="Group your requests into folders and collections. Share workspaces with configuration files."
            />
            <FeatureCard
              icon="public"
              color="teal"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="relative rounded-lg bg-[#0d1117] border border-gray-800 shadow-2xl p-6 font-mono text-sm leading-relaxed overflow-hidden">
              ...
              <div className="text-white">$ cd yasumu && cargo run</div>
...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    <div className="bg-white/[0.02] border border-white/5 p-8 rounded-xl hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 group cursor-default">
      <div
        className={`w-10 h-10 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border ${colorClasses[color]}`}
      >
