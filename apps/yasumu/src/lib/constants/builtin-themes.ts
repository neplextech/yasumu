...
export const BUILTIN_THEMES: YasumuThemeConfig[] = [
  {
    id: 'shadcn.blue-light',
    name: 'Blue',
    type: 'light',
    variables: {
      radius: '0.65rem',
  ...
  },
  {
    ...
    variables: {
      ...
      'shadow-sm':
        '1px 1px 2px 0px hsl(180 70% 60% / 0.2), 1px 1px 2px -1px hsl(180 70% 60% / 0.2)',
      shadow:
        '1px 1px 2px 0px hsl(180 70% 60% / 0.2), 1px 1px 2px -1px hsl(180 70% 60% / 0.2)',
      'shadow-md':
        '1px 1px 2px 0px hsl(180 70% 60% / 0.2), 1px 2px 4px -1px hsl(180 70% 60% / 0.2)',
      'shadow-lg':
        '1px 1px 2px 0px hsl(180 70% 60% / 0.2), 1px 4px 6px -1px hsl(180 70% 60% / 0.2)',
      'shadow-xl':
        '1px 1px 2px 0px hsl(180 70% 60% / 0.2), 1px 8px 10px -1px hsl(180 70% 60% / 0.2)',
