...
import { GuiWorkspaceReconciler, type WorkspaceReconciliationReport } from './headless-reconciliation.service.ts';
...
export class SynchronizationLoader {
  ...
  public loadAll(workspace: WorkspaceData): Promise<WorkspaceReconciliationReport> {
