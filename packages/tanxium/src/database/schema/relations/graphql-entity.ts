...
export const graphqlEntitiesRelations = relations(graphqlEntities, ({ one, many }) => ({
...
export const graphqlEntityDependenciesRelations = relations(graphqlEntityDependencies, ({ one }) => ({
