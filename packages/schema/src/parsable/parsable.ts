...
export abstract class YasumuSchemaParsable<T> {
  canParse(parser: YasumuSchemaParser): boolean {
    throw new YasumuSchemaParserError('Parsable does not support parse check operation');
  }

  canSerialize(serializer: YasumuSchemaSerializer, value: any): boolean {
    throw new YasumuSchemaParserError('Parsable does not support serialize check operation');
  }
...
export type YasumuSchemaParsableToType<T extends YasumuSchemaParsable<unknown>> =
