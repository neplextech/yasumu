...
1. Use `PascalCase` format if the file belongs to a class. Ex:
   `YasumuClient.ts`, `ProtocolService.ts`, etc.
2. Use `camelCase` format for the files that belong to functions. Ex:
   `contextMenu`, `appMenu`, etc.
